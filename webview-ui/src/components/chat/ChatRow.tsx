				...
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						{message.type === "ask" ? (
							...
							<>
								ZAKI {mcpServerUse.type === "use_mcp_tool" ? "used a tool" : "accessed a resource"} on
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "ZAKI wants to edit this file:" : "ZAKI edited this file:"}
							</span>
						</div>
						<CodeAccordian
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "ZAKI wants to create a new file:"
									: "ZAKI created a new file:"}
							</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}
